...
%% 计算值
output = -1 * inv(b) * (Ff + a_1_CP * k_1_CP * diag(abs(e_eta) .^ (a_1_CP - 1))) * (Flambda /  k_1_CP + e_varv_hat) + alpha_CP * PublicFunc_sig(gamma_1_CP, FS + beta_CP * PublicFunc_sig(gamma_2_CP, FS));
end